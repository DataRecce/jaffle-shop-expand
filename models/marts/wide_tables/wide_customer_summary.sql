...
order_stats as (
    ...
    select
        ...
        sum(case when has_food_items and has_drink_items then 1 else 0 end) as mixed_order_count,
        sum(case when has_food_items and not has_drink_items then 1 else 0 end) as food_only_order_count,
        sum(case when has_drink_items and not has_food_items then 1 else 0 end) as drink_only_order_count,
